...
export class MyScene extends CGFscene {
    ...
    init(application) {
        ...
        this.texture5 = new CGFtexture(this, 'images/mineBottom.png');
        this.texture6 = new CGFtexture(this, 'images/mineSide.png');
        //-------

        this.cube = new MyUnitCubeQuad(this, this.texture4, this.texture6, this.texture6, this.texture6, this.texture6, this.texture5);
    ...
    updateAppliedTexture() {
        if(this.displayQuad) this.quadMaterial.setTexture(this.textures[this.selectedTexture]);
    }

    //Function that updates wrapping mode in quadMaterial
    updateTextureWrapping() {
        if(this.displayQuad) this.quadMaterial.setTextureWrap(this.wrappingMethods[this.wrapS], this.wrappingMethods[this.wrapT]);
    }
