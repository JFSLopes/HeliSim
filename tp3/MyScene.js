...
export class MyScene extends CGFscene {
    ...
    init(application) {
        ...
        this.objects = [this.plane, this.pyramid, this.cone, this.tangram, this.cube, this.prisma, this.cylinder];
    ...
    initMaterials() {
        ...
        this.material4.setAmbient(0.471,0.294,0.102,1.0);
        this.material4.setDiffuse(0.471,0.294,0.102,1.0);
